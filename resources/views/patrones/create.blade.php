    ...
    <div class="container-fluid py-4">
        <div class="card">
            <div class="card-header">
                <h5 class="mb-0">Registrar Nuevo Patrón</h5>
            </div>
            <div class="card-body">
                @if ($errors->any())
                ...
                <form action="{{ route('patrones.store') }}" method="POST" enctype="multipart/form-data"> {{-- Importante: enctype para subir archivos --}}
                    @csrf

                    <div class="row">
                        <div class="col-md-6 mb-3">
                            <label for="nombre_comercial" class="form-label">Nombre Comercial <span class="text-danger">*</span></label>
                            <input type="text" class="form-control @error('nombre_comercial') is-invalid @enderror" id="nombre_comercial" name="nombre_comercial" value="{{ old('nombre_comercial') }}" required>
                    ...
                    <div class="mb-3">
                        ...
                        <textarea class="form-control @error('direccion_fiscal') is-invalid @enderror" id="direccion_fiscal" name="direccion_fiscal" rows="3">{{ old('direccion_fiscal') }}</textarea>
                    ...
                    <div class="mb-3">
                        ...
                        <textarea class="form-control @error('actividad_principal') is-invalid @enderror" id="actividad_principal" name="actividad_principal" rows="2">{{ old('actividad_principal') }}</textarea>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control @error('representante_legal') is-invalid @enderror" id="representante_legal" name="representante_legal" value="{{ old('representante_legal') }}">
                        @error('representante_legal') <div class="invalid-feedback">{{ $message }}</div> @enderror
                        <div class="form-text">Requerido principalmente para Personas Morales.</div>
                    </div>

                    <div class="mb-3">
                        <label for="logo_path" class="form-label">Logo del Patrón (Opcional)</label>
                    ...
                    <div class="text-end">
                        ...
                        <button type="submit" class="btn btn-primary">Guardar Patrón</button>
                    </div>
                </form>
            </div>
        </div>
