        ...
        <div class="card shadow-sm border-0">
            <div class="card-header bg-white border-bottom py-3">
                <h5 class="mb-0 fw-bold text-primary">
                    <i class="bi bi-pencil-square me-2"></i>Editar Patrón: {{ $patron->razon_social }}
                </h5>
            </div>
            <div class="card-body">
                @if ($errors->any())
                ...
                <form action="{{ route('patrones.update', $patron->id_patron) }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="text" class="form-control form-control-sm @error('nombre_comercial') is-invalid @enderror" id="nombre_comercial" name="nombre_comercial" value="{{ old('nombre_comercial', $patron->nombre_comercial) }}" required>
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="text" class="form-control form-control-sm @error('razon_social') is-invalid @enderror" id="razon_social" name="razon_social" value="{{ old('razon_social', $patron->razon_social) }}" required>
                    ...
                    <div class="row bg-light p-3 rounded mb-3 border">
                        <div class="col-md-4 mb-3">
                            ...
                            <input type="text" class="form-control form-control-sm @error('registro_patronal') is-invalid @enderror" id="registro_patronal" name="registro_patronal" value="{{ old('registro_patronal', $patron->registro_patronal) }}" maxlength="20" placeholder="Opcional, ej. B5510768108">
                        ...
                        <div class="col-md-4 mb-3">
                            ...
                            <input type="text" class="form-control form-control-sm @error('codigo_postal') is-invalid @enderror" id="codigo_postal" name="codigo_postal" value="{{ old('codigo_postal', $patron->codigo_postal) }}" maxlength="5" required placeholder="Ej. 56100">
                        ...
                        <div class="col-md-4 mb-3">
                            ...
                            <select class="form-select form-select-sm @error('regimen_fiscal') is-invalid @enderror" id="regimen_fiscal" name="regimen_fiscal" required>
                                ...
                                <option value="601" {{ old('regimen_fiscal', $patron->regimen_fiscal) == '601' ? 'selected' : '' }}>601 - General de Ley Personas Morales</option>
                                <option value="612" {{ old('regimen_fiscal', $patron->regimen_fiscal) == '612' ? 'selected' : '' }}>612 - Personas Físicas con Actividades Emp. y Prof.</option>
                                <option value="626" {{ old('regimen_fiscal', $patron->regimen_fiscal) == '626' ? 'selected' : '' }}>626 - Régimen Simplificado de Confianza (RESICO)</option>
                            </select>
                    ...
                    <div class="mb-3">
                        ...
                        <textarea class="form-control form-control-sm @error('direccion_fiscal') is-invalid @enderror" id="direccion_fiscal" name="direccion_fiscal" rows="2">{{ old('direccion_fiscal', $patron->direccion_fiscal) }}</textarea>
                    ...
                    <div class="mb-3">
                        ...
                        <textarea class="form-control form-control-sm @error('actividad_principal') is-invalid @enderror" id="actividad_principal" name="actividad_principal" rows="2">{{ old('actividad_principal', $patron->actividad_principal) }}</textarea>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control form-control-sm @error('representante_legal') is-invalid @enderror" id="representante_legal" name="representante_legal" value="{{ old('representante_legal', $patron->representante_legal) }}">
                        @error('representante_legal') <div class="invalid-feedback">{{ $message }}</div> @enderror
                    </div>

                    <div class="mb-4">
                        <label for="logo_path" class="form-label fw-bold small">Nuevo Logo del Patrón (Opcional)</label>
                        ...
                        <small class="text-muted" style="font-size: 0.75rem;">Si subes una nueva imagen, reemplazará a la actual.</small>
                        @error('logo_path') <div class="invalid-feedback">{{ $message }}</div> @enderror
                        
                        @if ($patron->logo_path)
                            <div class="mt-3 p-3 border rounded bg-light d-inline-block">
                                <p class="mb-2 fw-bold small text-secondary">Logo Actual:</p>
                                <img src="{{ asset('storage/' . $patron->logo_path) }}" alt="Logo Actual" class="shadow-sm bg-white" style="max-height: 80px; object-fit: contain; padding: 5px; border-radius: 5px;">
                            </div>
                        @endif
                    </div>
                    ...
                    <div class="text-end">
                        ...
                        <button type="submit" class="btn btn-primary fw-bold px-4"><i class="bi bi-save me-1"></i> Actualizar Patrón</button>
                    </div>
                </form>
            </div>
        </div>
