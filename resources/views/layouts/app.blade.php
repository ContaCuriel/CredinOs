...
<head>
   ...
   <style>
        ...
        main { margin-left: 0px; padding: 70px 20px 20px 20px; } /*<-- Se usa tu padding y margen original*/
...
<body>
    ...
    <div class="container-fluid">
        <div class="row">
            <nav id="sidebarMenu" class="col-md-3 col-lg-2 d-md-block sidebar collapse"> {{-- Se mantienen tus clases de columna --}}
                <div class="position-sticky pt-3 sidebar-sticky">
                    {{-- INICIO DEL MENÚ PROTEGIDO --}}
                    ...
                    <ul class="nav flex-column mb-2">
                        ...
                        @can('ver-asistencias')  <li class="nav-item">
