            ...
            <div class="card-body">
                ...
                <form action="{{ route('horarios.store') }}" method="POST">
                    ...
                    <div class="card border-warning bg-warning bg-opacity-10 p-3 mb-4" style="max-width: 500px;">
                        <div class="form-check form-switch mb-2">
                            <input class="form-check-input" type="checkbox" id="tiene_tolerancia" name="tiene_tolerancia" value="1" {{ old('tiene_tolerancia') ? 'checked' : '' }}>
                        ...
                        <div id="container_tolerancia" style="display: {{ old('tiene_tolerancia') ? 'block' : 'none' }};">
                            <label for="tolerancia_minutos" class="form-label small fw-bold text-dark">Minutos de tolerancia permitidos:</label>
                            <div class="input-group input-group-sm" style="width: 160px;">
                                <input type="number" class="form-control text-center" id="tolerancia_minutos" name="tolerancia_minutos" value="{{ old('tolerancia_minutos', 0) }}" min="0">
