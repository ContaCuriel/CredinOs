                ...
                <form action="{{ route('horarios.store') }}" method="POST">
                    ...
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="text" class="form-control @error('nombre_horario') is-invalid @enderror" id="nombre_horario" name="nombre_horario" value="{{ old('nombre_horario') }}" required placeholder="Ej: Oficina L-V, Ventas L-S">
                            @error('nombre_horario') <div class="invalid-feedback">{{ $message }}</div> @enderror
                        </div>
                        <div class="col-md-6 mb-3">
                            <label for="descripcion" class="form-label">Descripción (Opcional)</label>
                            <textarea class="form-control @error('descripcion') is-invalid @enderror" id="descripcion" name="descripcion" rows="1">{{ old('descripcion') }}</textarea>
                    ...
                    <div class="form-check form-switch mb-3">
                        <input class="form-check-input" type="checkbox" role="switch" id="aplicar_reglas_avanzadas" name="aplicar_reglas_avanzadas" value="1" {{ old('aplicar_reglas_avanzadas') ? 'checked' : '' }}>
                    ...
                    <div id="seccion_reglas_avanzadas" style="display: {{ old('aplicar_reglas_avanzadas') ? 'block' : 'none' }}; background-color: #f8f9fa; padding: 20px; border-radius: 8px; border: 1px solid #dee2e6;">
                        ...
                        <div class="row mb-4">
                            <div class="col-md-3 mb-2">
                                ...
                                <input type="number" class="form-control form-control-sm" id="tolerancia_minutos" name="tolerancia_minutos" value="{{ old('tolerancia_minutos', 10) }}">
                            ...
                            <div class="col-md-3 mb-2">
                                ...
                                <input type="number" class="form-control form-control-sm" id="retardo_menor_minutos_inicio" name="retardo_menor_minutos_inicio" value="{{ old('retardo_menor_minutos_inicio', 11) }}">
                            </div>
                            <div class="col-md-3 mb-2">
                                <label for="retardo_menor_minutos_fin" class="form-label small">Fin Retardo Menor</label>
                                <input type="number" class="form-control form-control-sm" id="retardo_menor_minutos_fin" name="retardo_menor_minutos_fin" value="{{ old('retardo_menor_minutos_fin', 15) }}">
                            </div>
                            <div class="col-md-3 mb-2">
                                <label for="retardos_para_falta" class="form-label small">¿Cuántos Retardos = Falta?</label>
                                <input type="number" class="form-control form-control-sm" id="retardos_para_falta" name="retardos_para_falta" value="{{ old('retardos_para_falta', 3) }}">
                        ...
                        <div class="row mb-4">
                            <div class="col-md-4 mb-2">
                                ...
                                <input type="number" class="form-control form-control-sm" id="medio_dia_minutos_inicio" name="medio_dia_minutos_inicio" value="{{ old('medio_dia_minutos_inicio', 16) }}">
                            </div>
                            <div class="col-md-4 mb-2">
                                <label for="medio_dia_minutos_fin" class="form-label small">Fin Medio Día (Min)</label>
                                <input type="number" class="form-control form-control-sm" id="medio_dia_minutos_fin" name="medio_dia_minutos_fin" value="{{ old('medio_dia_minutos_fin', 30) }}">
                            ...
                            <div class="col-md-4 mb-2">
                                ...
                                <input type="number" class="form-control form-control-sm" id="falta_minutos_inicio" name="falta_minutos_inicio" value="{{ old('falta_minutos_inicio', 31) }}">
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-2">
                                ...
                                <input type="number" step="0.5" class="form-control form-control-sm" id="castigo_falta_lun_vie" name="castigo_falta_lun_vie" value="{{ old('castigo_falta_lun_vie', 3) }}">
                            ...
                            <div class="col-md-6 mb-2">
                                ...
                                <input type="number" step="0.5" class="form-control form-control-sm" id="castigo_falta_mar_jue_sab" name="castigo_falta_mar_jue_sab" value="{{ old('castigo_falta_mar_jue_sab', 2) }}">
