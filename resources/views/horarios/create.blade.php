    ...
    <div class="container py-4">
        <div class="card shadow-sm">
            <div class="card-header bg-white d-flex justify-content-between align-items-center">
                <h5 class="mb-0 fw-bold text-dark"><i class="bi bi-clock-history text-primary"></i> Crear Nuevo Horario</h5>
                ...
                <form action="{{ route('horarios.store') }}" method="POST">
                    ...
                    <div class="row mb-4">
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="text" class="form-control" id="nombre_horario" name="nombre_horario" value="{{ old('nombre_horario') }}" placeholder="Ej. Matutino Oficina / Operis Ameca" required>
                        </div>
                        <div class="col-md-6 mb-3">
                            <label for="descripcion" class="form-label fw-bold">Descripción (Opcional)</label>
                            <input type="text" class="form-control" id="descripcion" name="descripcion" value="{{ old('descripcion') }}" placeholder="Breve nota sobre a quién aplica este horario">
                        </div>
                    </div>
                            ...
                            <div class="col">
                                <div class="card h-100 border bg-light p-3">
                                    <div class="form-check form-switch mb-2">
                                        <input class="form-check-switch form-check-input switch-dia" type="checkbox" id="check_{{ $key }}" name="{{ $key }}" value="1" {{ old($key) ? 'checked' : '' }}>
                                        <label class="form-check-label fw-bold text-dark" for="check_{{ $key }}">{{ $label }}</label>
                                    </div>
                                    <div id="inputs_{{ $key }}" class="container-inputs-dia" style="display: {{ old($key) ? 'block' : 'none' }};">
                                        <div class="mb-2">
                                            <label class="small text-muted mb-0">Entrada:</label>
                                            <input type="time" class="form-control form-control-sm" name="{{ $key }}_entrada" value="{{ old($key.'_entrada') }}">
                                        </div>
                                        <div>
                                            <label class="small text-muted mb-0">Salida:</label>
                                            <input type="time" class="form-control form-control-sm" name="{{ $key }}_salida" value="{{ old($key.'_salida') }}">
                                        </div>
                                    </div>
                                </div>
                            </div>
                    ...
                    @php
                        $tieneToleranciaCheck = old('tiene_tolerancia');
                    @endphp
                    <div class="card border-warning bg-warning bg-opacity-10 p-3 mb-3">
                        <div class="row">
                            <div class="col-md-4 border-end border-warning">
                                ...
                                <div id="container_tolerancia" style="display: {{ $tieneToleranciaCheck ? 'block' : 'none' }};">
                                    ...
                                    <div class="input-group input-group-sm mb-2">
                                        <input type="number" class="form-control" id="tolerancia_minutos" name="tolerancia_minutos" value="{{ old('tolerancia_minutos', 0) }}" min="0">
                            ...
                            <div class="col-md-4 border-end border-warning">
                                ...
                                <div class="input-group input-group-sm mb-2">
                                    <input type="number" class="form-control" name="minutos_limite_retardo" value="{{ old('minutos_limite_retardo', 15) }}" min="0">
                                    <span class="input-group-text">min</span>
                                </div>
                            ...
                            <div class="col-md-4">
                                ...
                                <div class="input-group input-group-sm mb-2">
                                    <input type="number" class="form-control" name="retardos_por_falta" value="{{ old('retardos_por_falta', 3) }}" min="0">
                    ...
                    {{-- BLOQUE: MEDIO DÍA --}}
                    @php
                        $aplicaMedioDiaCheck = old('aplica_medio_dia');
                    @endphp
                            ...
                            <div class="col-md-8">
                                <div id="container_medio_dia" style="display: {{ $aplicaMedioDiaCheck ? 'flex' : 'none' }}; align-items: center; gap: 15px;">
                                    ...
                                    <div class="input-group input-group-sm" style="width: 150px;">
                                        <input type="number" class="form-control" id="minutos_limite_medio_dia" name="minutos_limite_medio_dia" value="{{ old('minutos_limite_medio_dia', 30) }}" min="0">
                                        <span class="input-group-text">min</span>
                                    </div>
                    ...
                    @php
                        $aplicaMultiplicadorCheck = old('aplica_castigo_multiplicador');
                    @endphp
                                ...
                                <div id="container_multiplicadores" style="display: {{ $aplicaMultiplicadorCheck ? 'flex' : 'none' }}; gap: 15px;">
                                    <div>
                                        ...
                                        <div class="input-group input-group-sm">
                                            <input type="number" class="form-control" id="multiplicador_lunes_viernes" name="multiplicador_lunes_viernes" value="{{ old('multiplicador_lunes_viernes', 3) }}" min="1">
                                    ...
                                    <div>
                                        ...
                                        <div class="input-group input-group-sm">
                                            <input type="number" class="form-control" id="multiplicador_dias_regulares" name="multiplicador_dias_regulares" value="{{ old('multiplicador_dias_regulares', 2) }}" min="1">
                                            <span class="input-group-text">días</span>
                                        </div>
                                    </div>
                                </div>
