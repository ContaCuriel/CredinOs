            ...
            <div class="col-md-6 col-lg-5">
                <div class="card border-0 shadow-lg rounded-4 overflow-hidden">
                    <div class="card-header bg-dark text-white text-center py-4 border-0">
                        ...
                        <h4 class="fw-bold mb-0">Apertura de Caja Principal</h4>
                    ...
                    <div class="card-body p-4 bg-white text-center">
                        <form action="{{ route('cajas.abrir') }}" method="POST">
                            ...
                            {{-- Mandamos el ID de la caja oculta, ya que él es el único administrador --}}
                            ...
                            <div class="mb-4 text-start">
                                ...
                                <div class="input-group input-group-lg shadow-sm">
                                    ...
                                    <input type="number" step="0.01" min="0" class="form-control font-monospace text-primary fw-bold border-start-0" name="saldo_inicial" placeholder="Ej. 1000.00" required autofocus>
                                </div>
