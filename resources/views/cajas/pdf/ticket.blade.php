...
<head>
    ...
    <style>
        ...
        /* 🔥 Logo más grande 🔥 */
        .logo { max-width: 175px; max-height: 75px; margin-bottom: 5px; }
        ...
        /* 🔥 Más espacio para la firma (Enter doble) 🔥 */
        .firma-box { margin-top: 65px; text-align: center; font-size: 9pt; }
...
<body>
    ...
    <div class="text-center" style="font-size: 9pt;">
        {{ ucfirst($transaccion->metodo_pago) }}
    </div>
    ...
    <table class="table-info">
        ...
        <tr>
            ...
            <td>{{ mb_strtoupper($credito->nombre_credito ?? ($credito->grupo->nombre_grupo ?? 'INDIVIDUAL')) }}</td>
        </tr>
        <tr>
    ...
    <div class="firma-box">
        <div class="firma-line">Firma Cobrador</div>
    </div>
    
    <div class="text-center fw-bold" style="margin-top: 20px; font-size: 8pt; color: #333;">
        {{ mb_strtoupper($credito->patron->nombre_comercial ?? 'FINANCIERA') }}<br>
        ¡Gracias por su pago!
    </div>
