...
<head>
    ...
    <style>
        ...
        .signature-line { width: 70%; border-bottom: 1px solid black; margin: 4rem auto 0 auto; }
...
<body>
    ...
    <p class="text-end">
        {{-- Usamos la variable preparada desde el controlador --}}
        {{ $lugar_y_fecha_emision }}.
    </p>
    ...
    <p class="mt-4 text-justify">
        Por medio de la presente, yo, <span class="fw-bold">{{ $empleado->nombre_completo }}</span>, por convenir así a mis intereses particulares, con fecha <span class="fw-bold">{{ $fecha_baja_letra }}</span>, he resuelto dar por terminado voluntariamente
