...
<head>
    ...
    <style>
        ...
        header {
            ...
            line-height: 1.2;
            font-size: 11px;
            padding-top: .4cm; /* Ajusta este padding para el espacio superior */
        }

        .header-logo {
            max-height: 1.5cm; /* Altura máxima para tu logo, ajusta si es necesario */
            width: auto;
            margin-bottom: 0.4cm; /* Espacio debajo del logo */
        }
...
<body>
    ...
    <header>
        @if(isset($logo_base64) && $logo_base64) {{-- Verifica que la variable existe y no es nula/vacía --}}
            <img src="{{ $logo_base64 }}" class="header-logo" alt="Logo de la Empresa">
        @else
            {{-- Muestra la razón social si no hay logo en Base64 --}}
            <h3>{{ mb_strtoupper($patron->razon_social ?? 'RAZÓN SOCIAL NO ESPECIFICADA') }}</h3>
        @endif
    ...
    <main>
        ...
        <div class="signature-block">
            ...
            <div class="footer-info">
                ...
                <span class="bold">CONTADOR GENERAL</span><br>
