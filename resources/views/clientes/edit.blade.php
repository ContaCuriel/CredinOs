        ...
        <div class="card shadow-sm border-0">
            <div class="card-header bg-white py-3 d-flex justify-content-between align-items-center">
                <h5 class="mb-0 fw-bold text-dark">
                    <i class="bi bi-pencil-square me-2 text-warning"></i>Editar Cliente: {{ $cliente->nombre_completo }}
                </h5>
            ...
            <div class="card-body">
                ...
                <form action="{{ route('clientes.update', $cliente->id_cliente) }}" method="POST">
                    ...
                    <div class="accordion accordion-flush" id="accordionCliente">
                        ...
                        <div class="accordion-item border mb-3 rounded-3 shadow-sm">
                            ...
                            <div id="collapseOne" class="accordion-collapse collapse show" data-bs-parent="#accordionCliente">
                                <div class="accordion-body p-4">
                                    <div class="row">
                                        <div class="col-md-4 mb-3"><label class="form-label fw-bold">Nombre(s) <span class="text-danger">*</span></label><input type="text" class="form-control" name="nombre" value="{{ old('nombre', $cliente->nombre) }}" required></div>
                                        <div class="col-md-4 mb-3"><label class="form-label fw-bold">Apellido Paterno <span class="text-danger">*</span></label><input type="text" class="form-control" name="apellido_paterno" value="{{ old('apellido_paterno', $cliente->apellido_paterno) }}" required></div>
                                        <div class="col-md-4 mb-3"><label class="form-label fw-bold">Apellido Materno</label><input type="text" class="form-control" name="apellido_materno" value="{{ old('apellido_materno', $cliente->apellido_materno) }}"></div>
                                    </div>
                                    <div class="row">
                                        <div class="col-md-4 mb-3"><label class="form-label fw-bold">Fecha de Nacimiento <span class="text-danger">*</span></label><input type="date" class="form-control" name="fecha_nacimiento" value="{{ old('fecha_nacimiento', $cliente->fecha_nacimiento?->format('Y-m-d')) }}" required></div>
                                        <div class="col-md-4 mb-3"><label class="form-label fw-bold">CURP</label><input type="text" class="form-control text-uppercase" name="curp" value="{{ old('curp', $cliente->curp) }}"></div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-4 mb-3"><label class="form-label fw-bold">Teléfono Celular <span class="text-danger">*</span></label><input type="tel" class="form-control" name="telefono_celular" value="{{ old('telefono_celular', $cliente->telefono_celular) }}" required></div>
                                        <div class="col-md-4 mb-3"><label class="form-label fw-bold">Teléfono Fijo</label><input type="tel" class="form-control" name="telefono_fijo" value="{{ old('telefono_fijo', $cliente->telefono_fijo) }}"></div>
                                    </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-6 mb-3"><label class="form-label fw-bold">Municipio <span class="text-danger">*</span></label><input type="text" class="form-control" name="municipio" id="municipio" value="{{ old('municipio', $cliente->municipio) }}" required></div>
                                        <div class="col-md-6 mb-3"><label class="form-label fw-bold">Estado <span class="text-danger">*</span></label><input type="text" class="form-control" name="estado" id="estado" value="{{ old('estado', $cliente->estado) }}" required></div>
                                    </div>
                                    <div class="row">
                                        <div class="col-md-8 mb-3"><label class="form-label fw-bold">Calle <span class="text-danger">*</span></label><input type="text" class="form-control" name="calle" value="{{ old('calle', $cliente->calle) }}" required></div>
                                        <div class="col-md-4 mb-3"><label class="form-label fw-bold">Número <span class="text-danger">*</span></label><input type="text" class="form-control" name="numero" value="{{ old('numero', $cliente->numero) }}" required></div>
                                    </div>
                                    <div class="row">
                        ...
                        <div class="accordion-item border mb-3 rounded-3 shadow-sm">
                            ...
                            <div id="collapseTwo" class="accordion-collapse collapse" data-bs-parent="#accordionCliente">
                                <div class="accordion-body p-4">
                                    <div class="row">
                                        <div class="col-md-6 mb-3"><label class="form-label fw-bold">Nombre del Negocio / Empresa <span class="text-danger">*</span></label><input type="text" class="form-control" name="nombre_negocio" value="{{ old('nombre_negocio', $cliente->nombre_negocio) }}" required></div>
                                        <div class="col-md-6 mb-3">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6 mb-3"><label class="form-label fw-bold">Antigüedad del Negocio (años) <span class="text-danger">*</span></label><input type="number" class="form-control" name="antiguedad_negocio" value="{{ old('antiguedad_negocio', $cliente->antiguedad_negocio) }}" min="0" required></div>
                                    </div>
                                    ...
                                    <div class="form-check form-switch mb-3">
                                        <input class="form-check-input" type="checkbox" role="switch" id="mismo_domicilio" name="mismo_domicilio_laboral" value="1" {{ old('mismo_domicilio_laboral', $cliente->mismo_domicilio_laboral) ? 'checked' : '' }}>
                                    ...
                                    <div id="seccion_domicilio_negocio">
                                        <div class="row">
                                            <div class="col-md-3 mb-3"><label class="form-label fw-bold">Código Postal</label><input type="text" class="form-control" name="codigo_postal_negocio" value="{{ old('codigo_postal_negocio', $cliente->codigo_postal_negocio) }}"></div>
                                            <div class="col-md-5 mb-3"><label class="form-label fw-bold">Colonia</label><input type="text" class="form-control" name="colonia_negocio" value="{{ old('colonia_negocio', $cliente->colonia_negocio) }}"></div>
                                            <div class="col-md-4 mb-3"><label class="form-label fw-bold">Municipio</label><input type="text" class="form-control" name="municipio_negocio" value="{{ old('municipio_negocio', $cliente->municipio_negocio) }}"></div>
                                        </div>
                                        <div class="row">
                                            <div class="col-md-4 mb-3"><label class="form-label fw-bold">Estado</label><input type="text" class="form-control" name="estado_negocio" value="{{ old('estado_negocio', $cliente->estado_negocio) }}"></div>
                                            <div class="col-md-6 mb-3"><label class="form-label fw-bold">Calle</label><input type="text" class="form-control" name="calle_negocio" value="{{ old('calle_negocio', $cliente->calle_negocio) }}"></div>
                                            <div class="col-md-2 mb-3"><label class="form-label fw-bold">Número</label><input type="text" class="form-control" name="numero_negocio" value="{{ old('numero_negocio', $cliente->numero_negocio) }}"></div>
                                        </div>
                                    </div>
                                ...
                                <div class="accordion-body p-4">
                                    @for ($i = 0; $i < 2; $i++)
                                        <div class="p-3 bg-light rounded-3 mb-3 border">
                                            ...
                                            <div class="row">
                                                <div class="col-md-4 mb-3"><label class="form-label fw-bold">Nombre Completo <span class="text-danger">*</span></label><input type="text" class="form-control" name="referencias[{{ $i }}][nombre_referencia]" value="{{ old('referencias.'.$i.'.nombre_referencia', $cliente->referencias[$i]->nombre_referencia ?? '') }}" required></div>
                                                <div class="col-md-4 mb-3"><label class="form-label fw-bold">Parentesco <span class="text-danger">*</span></label><input type="text" class="form-control" name="referencias[{{ $i }}][parentesco]" value="{{ old('referencias.'.$i.'.parentesco', $cliente->referencias[$i]->parentesco ?? '') }}" required></div>
                                                <div class="col-md-4 mb-3"><label class="form-label fw-bold">Teléfono <span class="text-danger">*</span></label><input type="tel" class="form-control" name="referencias[{{ $i }}][telefono]" value="{{ old('referencias.'.$i.'.telefono', $cliente->referencias[$i]->telefono ?? '') }}" required></div>
                                            </div>
                                        </div>
                                    @endfor
                                </div>
                    ...
                    <div class="text-end mt-4">
                        ...
                        <button type="submit" class="btn btn-primary px-4 shadow-sm"><i class="bi bi-floppy-fill me-1"></i> Actualizar Cliente</button>
                    </div>
                </form>
            </div>
        </div>
