    ...
    <div class="container-fluid py-4">
        <div class="card">
            <div class="card-header">
                <h5 class="mb-0">Editar Empleado: {{ $empleado->nombre_completo }}</h5>
            </div>
            <div class="card-body">
                @if ($errors->any())
                ...
                <form action="{{ route('empleados.update', $empleado->id_empleado) }}" method="POST">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            {{-- ... (Campos de nombre_completo) ... --}}
                             <div class="mb-3">
                                ...
                                <input type="text" class="form-control" id="nombre_completo" name="nombre_completo" value="{{ old('nombre_completo', $empleado->nombre_completo) }}" required>
                            </div>
                            <div class="mb-3">
                            ...
                            <div class="mb-3">
                                ...
                                <select class="form-select" id="id_sucursal" name="id_sucursal" required>
                                    ...
                                    @foreach ($sucursales as $sucursal)
                                        <option value="{{ $sucursal->id_sucursal }}" {{ old('id_sucursal', $empleado->id_sucursal) == $sucursal->id_sucursal ? 'selected' : '' }}>
                            ...
                            <div class="mb-3">
                                ...
                                <select class="form-select @error('id_horario') is-invalid @enderror" id="id_horario" name="id_horario" required>
                                    @foreach ($horarios as $horario)
                                        {{-- El `old()` intenta recuperar el valor anterior, si no existe, usa el que ya tiene el empleado --}}
                             ...
                             <div class="mb-3">
                                ...
                                <input type="date" class="form-control @error('fecha_ingreso') is-invalid @enderror" id="fecha_ingreso" name="fecha_ingreso" value="{{ old('fecha_ingreso', $empleado->fecha_ingreso ? \Carbon\Carbon::parse($empleado->fecha_ingreso)->format('Y-m-d') : '') }}" required>
                                @error('fecha_ingreso') <div class="invalid-feedback">{{ $message }}</div> @enderror
                            </div>
                             <div class="mb-3">
                                <label for="fecha_nacimiento" class="form-label">Fecha de Nacimiento <span class="text-danger">*</span></label>
                                <input type="date" class="form-control @error('fecha_nacimiento') is-invalid @enderror" id="fecha_nacimiento" name="fecha_nacimiento" value="{{ old('fecha_nacimiento', $empleado->fecha_nacimiento ? \Carbon\Carbon::parse($empleado->fecha_nacimiento)->format('Y-m-d') : '') }}" required>
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control @error('nacionalidad') is-invalid @enderror" id="nacionalidad" name="nacionalidad" value="{{ old('nacionalidad', $empleado->nacionalidad) }}">
                            ...
                            <div class="mb-3">
                                ...
                                <select class="form-select @error('estado_civil') is-invalid @enderror" id="estado_civil" name="estado_civil">
                                    ...
                                    <option value="Otro" {{ old('estado_civil', $empleado->estado_civil) == 'Otro' ? 'selected' : '' }}>Otro</option>
                                </select>
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control @error('curp') is-invalid @enderror" id="curp" name="curp" value="{{ old('curp', $empleado->curp) }}" required>
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control @error('rfc') is-invalid @enderror" id="rfc" name="rfc" value="{{ old('rfc', $empleado->rfc) }}" required>
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control @error('nss') is-invalid @enderror" id="nss" name="nss" value="{{ old('nss', $empleado->nss) }}" required>
                             ...
                             <div class="mb-3">
                                ...
                                <input type="text" class="form-control @error('cuenta_bancaria') is-invalid @enderror" id="cuenta_bancaria" name="cuenta_bancaria" value="{{ old('cuenta_bancaria', $empleado->cuenta_bancaria) }}">
                                @error('cuenta_bancaria') <div class="invalid-feedback">{{ $message }}</div> @enderror
                            </div>
                            <div class="mb-3">
                                <label for="banco" class="form-label">Banco</label>
                                <input type="text" class="form-control @error('banco') is-invalid @enderror" id="banco" name="banco" value="{{ old('banco', $empleado->banco) }}">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control @error('contacto_emerg_nombre') is-invalid @enderror" id="contacto_emerg_nombre" name="contacto_emerg_nombre" value="{{ old('contacto_emerg_nombre', $empleado->contacto_emerg_nombre) }}">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control @error('contacto_emerg_telefono') is-invalid @enderror" id="contacto_emerg_telefono" name="contacto_emerg_telefono" value="{{ old('contacto_emerg_telefono', $empleado->contacto_emerg_telefono) }}">
                    ...
                    <div class="row">
                        <div class="col-md-12 mb-3">
                            ...
                            <textarea class="form-control @error('info_cartas_recomendacion') is-invalid @enderror" id="info_cartas_recomendacion" name="info_cartas_recomendacion" rows="3">{{ old('info_cartas_recomendacion', $empleado->info_cartas_recomendacion) }}</textarea>
