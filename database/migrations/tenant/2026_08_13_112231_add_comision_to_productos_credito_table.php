...
return new class extends Migration
{
    public function up(): void
    {
        ...
        $sql = "ALTER TABLE \"$schema\".productos_credito ADD COLUMN cobro_comision_apertura DECIMAL(5,2) DEFAULT 0.00";
    ...
    public function down(): void
    {
        ...
        $sql = "ALTER TABLE \"$schema\".productos_credito DROP COLUMN cobro_comision_apertura";
        DB::connection('tenant')->statement($sql);
    }
};