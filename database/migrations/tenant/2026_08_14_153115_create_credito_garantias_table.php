...
return new class extends Migration
{
    public function up(): void
    {
        ...
        // 1. Agregamos el switch de "requiere_garantia" a la tabla de productos
        ...
        // 2. Creamos la tabla de garantías con el "rastreador" integrado
        DB::connection('tenant')->statement("CREATE TABLE \"$schema\".credito_garantias (
            id SERIAL PRIMARY KEY,
            credito_id BIGINT NOT NULL,
            tipo_garantia VARCHAR(50) NOT NULL, -- 'vehiculo' o 'propiedad'
            
            -- Campos para Vehículo[cite: 1]
            ...
            -- Campos para Terreno/Propiedad[cite: 2]
            ...
            -- Campos para el Rastreo Físico que pediste (Cadena de Custodia)
            estatus_resguardo VARCHAR(50) DEFAULT 'En Bóveda Sucursal', -- Ej. En Tránsito, En Corporativo, Devuelta
    ...
    public function down(): void
    {
        ...
        DB::connection('tenant')->statement("DROP TABLE IF EXISTS \"$schema\".credito_garantias CASCADE;");
        DB::connection('tenant')->statement("ALTER TABLE \"$schema\".productos_credito DROP COLUMN IF EXISTS requiere_garantia;");
    }
};