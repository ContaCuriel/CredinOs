    ...
    public function edit(Role $role): View // <-- Esta 'View' ahora será reconocida correctamente
{
    ...
    private function getGroupedPermissions()
    {
        ...
        $permissionsStructure = [
            ...
            'Contabilidad' => ['ver-gastos', 'crear-gastos', 'editar-gastos', 'eliminar-gastos', 'aprobar-gastos', 'ver-reportes', 'ver-cuentas', 'crear-cuentas', 'editar-cuentas', 'eliminar-cuentas', 'ver-polizas', 'ver-detalle-polizas', 'ver-colocaciones', 'ver-recuperaciones'],'descargar-reporte-ejecutivo-ia',
