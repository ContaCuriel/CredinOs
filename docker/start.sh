...
php artisan storage:link || echo "Storage link ya existe, continuando..."
...
# Usamos 'yes' para saltar preguntas de confirmación si aparecen
yes | php artisan tenants:migrate || echo "Advertencia en migraciones, continuando..."

echo "6. Sembrando datos de INQUILINOS (Arreglo del Menú)..."
# --- EL TRUCO MAESTRO ---
# El comando 'yes' envía una 'y' + Enter automáticamente a la pregunta de Laravel
yes | php artisan db:seed-tenants
